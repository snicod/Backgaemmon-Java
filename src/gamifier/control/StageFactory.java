...
public class StageFactory {
    ...
    public static void registerModel(String stageName, String className) {
        stageModelNames.put(stageName, className);
    }
    public static void registerView(String stageName, String className) {
        stageViewNames.put(stageName, className);
    }
