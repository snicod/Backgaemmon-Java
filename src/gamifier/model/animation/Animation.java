...
public abstract class Animation {
    ...
    protected int frameGap; // CAUTION : shoud be normally gamifier.model.Model.frameGap to have an animation synchronized with the framerate
    ...
    protected int type;
    // the callbacks
    protected AnimationCallback onStartCallback;
    protected AnimationCallback onEndCallback;
    ...
    public void onStart(AnimationCallback function) {
